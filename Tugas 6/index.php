        ...
        <div class="grid_7">
            <div class="side-right">
                ...
                <div class="main">
                    ...
                    <table class="education" id="result">
                    ...
                    <div class="form-group input-group">
                        <form action="post" name="add_name" id="add_name">
                            <table class="table table-bordered" id="dynamic_field">
                                <tr>
                                    <td>
                                        <input type="text" name="jenjang[]" id="jenjang" placeholder="Enter education" class="form-control name_list">
                                    </td>
                                    <td>
                                        <input type="text" name="tahun1[]" id="tahun1" placeholder="Tahun Masuk" class="form-control name_list">
                                    </td>
                                    <td>
                                        <input type="text" name="tahun2[]" id="tahun2" placeholder="Tahun Lulus" class="form-control name_list">
                                    </td>
                                </tr>
                            </table>
